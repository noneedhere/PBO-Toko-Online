...
public class Transaksi {
    ...
    private ArrayList<Integer> idBarang = new ArrayList<Integer>();
     ...
     public void getTransaksi(Member member, Transaksi transaksi, Barang barang){
     ...
     do{
        ...
        for (int j = 0; j < x; j++){
            ...
            idBarang.get(j)+"\t"+ barang.getHarga(idBarang.get(j))+"\t"+jumlah);transaksi.setTransaksi(barang, idMember, idBarang.get(j), banyak.get(j));
        }
